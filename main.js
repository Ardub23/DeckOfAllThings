...
class Card {
	...
	constructor(name, desc, args) {
		...
		this.wildness = (args.wildness !== undefined) ? args.wildness : 0.5;
		this.worth = (args.worth !== undefined) ? args.worth : 0.5;
		this.noXPDesc = args.noXPDesc;
		this.noLevelDesc = args.noLevelDesc;
		this.drawsEffect = (args.drawsEffect !== undefined) ? args.drawsEffect : "noeffect";
		this.draws = (args.draws !== undefined) ? args.draws : 1;
		this.reappears = (args.reappears !== undefined) ? args.reappears : true;
		this.onDrawMore = args.onDrawMore;
		this.weight = (args.weight !== undefined) ? args.weight : 1.0;
		this.noAlignDesc = args.noAlignDesc;
...
let fullDeck = [
	...
	new Card("Moon",
		"You are granted the ability to cast the [_wish_](https://www.dndbeyond.com/spells/wish) spell 1d3 times.",
		{ wildness: 1.0, worth: 1.0 }),
	new Card("Star",
		"Increase one of your ability scores by 2. The score can exceed 20 but can't exceed 24.",
		{ wildness: 0.0, worth: 1.0 }),
	new Card("Comet",
	...
	new Card("Idiot",
		...
		{
			wildness: 0.2, worth: 0.2,
			drawsEffect: "optional", draws: 1
		}),
	new Card("Donjon",
		"You disappear and become entombed in a state of suspended animation in an extradimensional sphere. Everything you were wearing and carrying stays behind in the space you occupied when you disappeared. You remain imprisoned until you are found and removed from the sphere. You can't be located by any divination magic, but a [_wish_](https://www.dndbeyond.com/spells/wish) spell can reveal the location of your prison. You draw no more cards.",
		{
			wildness: 0.9, worth: 0.0,
			drawsEffect: "nomore"
		}),
	new Card("Ruin",
		"All forms of wealth that you carry or own, other than magic items, are lost to you. Portable property vanishes. Businesses, buildings, and land you own are lost in a way that alters reality the least. Any documentation that proves you should own something lost to this card also disappears.",
		{ wildness: 0.7, worth: 0.1 }),
	new Card("Euryale",
		...
		{ wildness: 0.3, worth: 0.0 }),
	new Card("Rogue",
		"A nonplayer character of the DM's choice becomes hostile toward you. The identity of your new enemy isn't known until the NPC or someone else reveals it. Nothing less than a [_wish_](https://www.dndbeyond.com/spells/wish) spell or divine intervention can end the NPC's hostility toward you.",
		{ wildness: 0.1, worth: 0.4 }),
	new Card("Balance",
		...
		{
			wildness: 0.5, worth: 0.4,
			noAlignDesc: "Your mind suffers a wrenching alteration, compelling you to behave contrary to your usual ways. You are affected by a 9th-level [_geas_](https://www.dndbeyond.com/spells/geas) spell; you aren't charmed but suffer the other effects as if you were. The DM determines the geas's instructions."
		}),
	new Card("Fool",
		"You lose 10,000 XP, discard this card, and draw from the deck again, counting both draws as one of your declared draws. If losing that much XP would cause you to lose a level, you instead lose an amount that leaves you with just enough XP to keep your level.",
		{
			...
			drawsEffect: "forced", draws: 1,
			reappears: false
		}),
	new Card("Jester",
		"You gain 10,000 XP, or you can draw two additional cards beyond your declared draws.",
		{
			wildness: 0.2, worth: 0.7,
...
let homebrewDeck = [
	new Card("Changeling",
		"Your body crumbles to dust, which immediately reconstitutes itself into a new body for you. Roll on the table from the [_reincarnate_](https://www.dndbeyond.com/spells/reincarnate) spell to determine your new race. Your racial traits change accordingly.",
		{ wildness: 0.4, worth: 0.4 }),
	new Card("Beacon",
		"All items you are wearing or carrying begin glowing as if affected by a [_light_](https://www.dndbeyond.com/spells/light) cantrip that lasts until dispelled.",
		{ wildness: 0.0, worth: 0.5 }),
	new Card("Superbia",
	...
	new Card("Lottery",
		...
		{
			wildness: 0.5, worth: 0.6,
			drawsEffect: "optional", draws: 5,
			reappears: false,
			onDrawMore: "addVeto"
		}),
	...
	new Card("Medic",
		"You gain the ability to cast the [_power word heal_](http://dnd5e.wikidot.com/spell:power-word-heal) spell 3 times. You can't target yourself with it.",
		{ wildness: 0.8, worth: 1.0 }),
	new Card("Meteor",
		...
		{ wildness: 0.7, worth: 1.0 }),
	new Card("Doldrums",
		"You gain a level of exhaustion. Rest can't reduce your exhaustion level below 1. If your exhaustion level is reduced to 0 another way, you regain a level of exhaustion after 24 hours. Only a [_wish_](https://www.dndbeyond.com/spells/wish) spell or divine intervention can end this effect.",
		{ wildness: 0.4, worth: 0.2 }),
	new Card("Inquisitor",
		...
		{ wildness: 0.3, worth: 0.9 }),
	new Card("Oaf",
		"Choose two skills with which you are proficient. You have a &minus;5 penalty to all checks you make with those skills. The penalty can be removed only by a [_wish_](https://www.dndbeyond.com/spells/wish) spell or divine intervention.",
		{ wildness: 0.5, worth: 0.1 }),
	...
	new Card("The Deep",
		...
		{ wildness: 0.3, worth: 0.5 }),
	new Card("Academia",
		"Your Intelligence score increases by 10 (to a maximum of 30), and your Strength score is reduced by 10 (to a minimum of 1). Each day at dawn, your Intelligence score is reduced by 1 and your Strength score increases by 1; this continues for 1d4&nbsp;+&nbsp;5 days, after which the remaining changes become permanent.",
		{ wildness: 0.3, worth: 0.4 }),
	...
	new Card("Summons",
		...
		{ wildness: 0.5, worth: 0.6 }),
	new Card("Connection",
		"You can cast the [_detect thoughts_](https://www.dndbeyond.com/spells/detect-thoughts) spell once without expending a spell slot, and you regain the ability to do so when you finish a long rest. When you cast it in this way, creatures you focus on automatically know you are probing into their minds, and they can read your mind in the same way for as long as you focus on them.",
		{ wildness: 0.4, worth: 0.6 }),
	new Card("Waif",
		"You vanish from your current plane of existence, leaving the deck behind, and appear in the Ethereal Plane as if by the [_etherealness_](https://www.dndbeyond.com/spells/etherealness) spell. This effect lasts indefinitely and can't be dispelled or dismissed. You draw no more cards.",
		{
			wildness: 0.8, worth: 0.1,
			drawsEffect: "nomore"
		}),
	...
	new Card("Diagram",
		...
		{ wildness: 0.7, worth: 0.6 }),
	new Card("Prophet",
		"Four ivory strips worth 50&nbsp;gp each, and incense worth 1000&nbsp;gp, appear at your feet. You can cast the [_legend lore_](https://www.dndbeyond.com/spells/legend-lore) spell once without using a spell slot, and you regain the ability to do so when you finish a long rest.",
		{ wildness: 0.4, worth: 0.8 }),
	new Card("Pariah",
	...
	new Card("Barrier",
		...
		{ wildness: 0.1, worth: 0.5 }),
	new Card("Wyrm",
		"You gain the ability to transform into an adult dragon of your choice, as if by the [_shapechange_](https://www.dndbeyond.com/spells/shapechange) spell (no concentration required). You can use this ability once.",
		{ wildness: 0.5, worth: 1.0 }),
	new Card("The Devil",
	...
	new Card("Memory",
		...
		{ wildness: 0.5, worth: 0.9 }),
	new Card("Phoenix",
		"After you die, burning your remains to ash indefinitely extends the time limit on spells that raise you from the dead. Any spell which would revive you has the same effects as [_true resurrection_](https://www.dndbeyond.com/spells/true-resurrection), provided your remains were burned within the spell's original time limit and the caster touches the ashes. The body created by the spell can be younger than you were when you died, as you choose. When you drop to 0 hit points, you can choose to be engulfed in flame, dying and turning to ash immediately.",
		{ wildness: 0.8, worth: 1.0 }),
	new Card("Storm",
...
function exportDeck() {
	...
	for (let i in deck) {
		const c = deck[i];
		if (c.name || c.desc)
			strippedDeck.push(new Card(
				c.name,
				c.desc,
				{
					drawsEffect: c.drawsEffect, draws: c.draws,
					reappears: c.reappears,
					onDrawMore: c.onDrawMore,
					weight: c.weight,
					onDraw: c.onDraw
				})
			);

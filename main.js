...
let homebrewDeck = [
	...
	new Card("Bitter Cold",
			 ...
			 0.4, 0.1),
	new Card("Summons",
			 "Once within the next 30 days, you can name or describe one creature. The creature appears in the nearest unoccupied space to you, even if it was on another plane of existence. If you use a broad description that matches more than one creature (such as \"a human blacksmith\"), the nearest one is summoned.",
			 0.5, 0.6),
	new Card("Connection",
			 "You can cast the [wish](https://www.dndbeyond.com/spells/detect-thoughts) spell once without expending a spell slot, and you regain the ability to do so when you finish a long rest. When you cast it in this way, creatures you focus on automatically know you are probing into their minds, and they can read your mind in the same way for as long as you focus on them.",
			 0.4, 0.6),
	new Card("Waif",
	...
	new Card("Liar",
			 ...
			 0.4, 0.2),
	new Card("Obol",
			 "You gain proficiency in death saving throws. You can't become undead after you die. Unless you are willing, you can't be sent to another plane of existence, and your soul can't be removed from your body by any means except death. With a touch, you can transfer all of this card's effects to another creature; you no longer have the effects if you do this. If you are a construct or undead, you don't gain this card's benefits, but you can still transfer them to another creature.",
			 0.2, 0.9),
